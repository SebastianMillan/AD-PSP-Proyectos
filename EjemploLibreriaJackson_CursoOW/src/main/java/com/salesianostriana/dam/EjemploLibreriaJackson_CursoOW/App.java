package com.salesianostriana.dam.EjemploLibreriaJackson_CursoOW;
...
public class App {
	...
	public static void main(String[] args) {
		...
		Vehicle veh2 = new Vehicle("veh2", 1.2, 1990, cust1);
		...
		Vehicle veh6 = new Vehicle("veh6", 1.2, 1990, cust4);
